    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 bg-cream dark:bg-night">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-32 -left-32 w-96 h-96 bg-gradient-to-br from-gold/10 to-teal/10 dark:from-gold-neon/5 dark:to-teal-neon/5 rounded-full blur-3xl" />
                <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-gradient-to-br from-teal/10 to-gold/10 dark:from-teal-neon/5 dark:to-gold-neon/5 rounded-full blur-3xl" />
            </div>
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-stone-text dark:text-dark-muted">Masuk ke akun Anda</p>
                </div>
                ...
                <div className="bg-white dark:bg-night-surface rounded-2xl shadow-xl border border-stone-100/60 dark:border-night-border/60 p-8">
                    ...
                    <p className="text-center text-sm text-stone-text dark:text-dark-muted">
                        Belum punya akun?{' '}
                        <Link to="/register" className="text-gold dark:text-gold-neon font-semibold hover:underline">
                            Daftar sekarang
                        </Link>
                    </p>
                </div>
